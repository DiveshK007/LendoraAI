export type UTxO = Record<string, any>;
...
export type ServerOutput = Greetings | HeadIsInitializing | HeadIsOpen | HeadIsClosed | HeadIsAborted | HeadIsFinalized | TxValid | TxInvalid | SnapshotConfirmed | PeerConnected | PeerDisconnected | CommandFailed | PostTxOnChainFailed;
...
export type ClientInput = Init | Abort | Commit | NewTx | GetUTxO | Close | Fanout;
export declare enum HydraState {
    IDLE = "IDLE",
